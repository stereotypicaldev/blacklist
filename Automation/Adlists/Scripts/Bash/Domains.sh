...
OUTPUT_FILE="/root/Blacklist/Domains/Exact Blacklist/domains.txt"
OUTPUT_DIR=$(dirname "$OUTPUT_FILE")
ERROR_FILE="/root/Blacklist/Domains/Exact Blacklist/Execution_Error.txt"
...
sqlite3 "$DATABASE" "SELECT domain FROM domainlist WHERE type=1;" > "$OUTPUT_FILE"
